# -*- coding: utf-8 -*-
"""
Created on Mon Jun 13 16:07:46 2022
...
def get_MA(stock_id, period="12mo"):
    ...
    df["ROC_10"]=talib.ROC(df["收盤價"]) #計算ROC_10
    df["ROC_10_T1"]=df["ROC_10"].shift(1) #前一日ROC_10
    df["ROC_10_T2"]=df["ROC_10"].shift(2) #前兩日ROC_10
...
def trade(df):
    ...
    for index, row in df.copy().iterrows():
        ...
        #賣出條件
        #賣出條件1 今日ROC_10>=前兩日ROC_10 且 前一日ROC_10>今日ROC_10
        #賣出條件2 今日SMA20<前一日SMA20
        sell_condition_1=(row["ROC_10"]>=row["ROC_10_T2"]) and (row["ROC_10_T1"]>row["ROC_10"])
        sell_condition_2=row["SMA_20"]<row["SMA_20_T1"]
        sell_condition_3=row["ROC_10"]<0
